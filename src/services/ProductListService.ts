...
export class ProductListService {
    ...
    public async addToProductList(productList: ProductList, product: Product, quantity: Number): Promise<ProductList | undefined> {
        ...
        try {
            existingProductInCart = await new ProductListService().findProductListProduct(productList, product);
        }
